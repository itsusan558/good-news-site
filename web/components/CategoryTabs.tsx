      ...
      {CATEGORIES.map((cat) => {
        ...
        return (
          <Link
            ...
            className={`
              flex-shrink-0 px-4 py-2.5 min-h-[44px] rounded-full text-sm font-medium transition-all inline-flex items-center
              ${
                isActive
                  ? `${cat.bgColor} ${cat.color} ring-2 ring-current ring-opacity-30`
                  : ""
              }
            `}
            style={
